                                            ...
                                            <table class="table table-report sm:mt-2">
                                                ...
                                                <tbody id="table_data">
                                                    ...
                                                    <tr class="intro-x">
                                                        ...
                                                        <td class="text-left"><input  id="bordered-radio-3" type="radio" value="" name="bordered-radio4" class="checked"></td>
                                                        <td class="text-left"><input  id="bordered-radio-3" type="radio" value="" name="bordered-radio4" class=""></td>
                                                        <td class="text-left"><input  id="bordered-radio-3" type="radio" value="" name="bordered-radio4" class=""></td>
                                                    </tr>
                                                    <tr class="intro-x">
                                                        ...
                                                        <td class="text-left"><input  id="bordered-radio-3" type="radio" value="" name="bordered-radio5" class="checked"></td>
                                                        <td class="text-left"><input  id="bordered-radio-3" type="radio" value="" name="bordered-radio5" class=""></td>
                                                        <td class="text-left"><input  id="bordered-radio-3" type="radio" value="" name="bordered-radio5" class=""></td>
                                                    </tr>
                                                </tbody>
                                            </table>
