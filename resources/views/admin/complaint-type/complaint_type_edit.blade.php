                        ...
                        <div class="preview">
                            <div class="grid grid-cols-12 gap-2">
                                <div>
                                    ...
                                    <select data-placeholder="Select your favorite actors" id="product_category_a"
                                        name='product_category' class="tom-select w-full tomselected" id="tomselect-1"
                                        tabindex="-1" hidden="hidden" onchange="productA(this.value)">
                                        ...
                                        @for ($i = 0; $i < count($complaintCategory); $i++)
                                            <option value="{{ $complaintCategory[$i]->id }}"
                                                {{ $complaintType->product_category_id == $complaintCategory[$i]->id ? 'Selected' : '' }}>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control col-span-4" name="complaint_type"
                                        value="{{ $complaintType->fullname }}" placeholder="Type name"
                                        aria-label="default input inline 2">
                                </div>
                                <div>
                                    <label for="regular-form-1" class="form-label">Turn Around Time <span
                                            style="color: red">*</span></label>
                                    <input type="text" class="form-control col-span-4" name="turn_around_time"
                                        value="{{ $complaintType->tat }}" onkeypress="return validateNumbers(event)"
                                        placeholder="Turn Around Time" aria-label="default input inline 2">
                                ...
                                <div class="form-check form-switch  mt-3 sm:mt-0">
                                    ...
                                    <input id="show-example-3" data-target="#header" name='is_active' value="1"
                                        {{ $complaintType->isactive == '1' ? 'Checked' : '' }}
