                    ...
                    <div class="preview">
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <div class="mt-3">
                                ...
                                <textarea id="validation-form-6" onkeyup="validateAlphabetsAndNUumber(event)" maxlength='255' class="form-control" name="note" placeholder="Complete Address" minlength="10" required=""></textarea>
                            </div>
                            <div class="mt-3">
                            ...
                            <div class="mt-3">
                                ...
                                <textarea id="validation-form-6" onkeyup="validateAlphabetsAndNUumber(event)" maxlength='255' class="form-control" name="note" placeholder="Enter Details about inquiry" minlength="10" required=""></textarea>
                            </div>
                        </div>
