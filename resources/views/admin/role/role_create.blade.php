...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            <form method="POST" action="{{ route('role.store') }}" onsubmit="return validation()">
                @csrf
                <!-- BEGIN: Input -->
                    ...
                    <div id="inline-form" class="p-5">
                        <div class="preview">
                            <div class="grid grid-cols-12 gap-2">
                                <div>
                                    <label for="regular-form-1" class="form-label">Primary Name <span
                                            style="color: red">*</span></label>
                                    <input type="text" class="form-control col-span-4" name="primary_name"
                                        placeholder="Primary Name" aria-label="default input inline 2" required>
                                </div>
                                <div>
                                    <label for="regular-form-1" class="form-label">Secondary Name <span
                                            style="color: red">*</span></label>
                                    <input type="text" class="form-control col-span-4" name="secondary_name"
                                        placeholder="Secondary Name" aria-label="default input inline 2" required>
                                </div>
                                <div>
                                    <label for="regular-form-1" class="form-label">E-Mail Address</label>
                                    <input type="text" class="form-control col-span-4" name="email"
                                        placeholder="E-Mail Address" aria-label="default input inline 1">
                                </div>
                                <div class="mt-3">
                                ...
                                <div class="form-check form-switch  sm:mt-0" style="margin-top: 46px;">
                                    ...
                                    <input id="show-example-3" data-target="#header" name="isactive" checked value="1"
                                ...
                                <div class="accordion-item">
                                    <div id="faq-accordion-content-5" class="accordion-header">
                                        <button class="accordion-button" type="button" data-tw-toggle="collapse"
                                            ...
                                            aria-controls="faq-accordion-collapse-5">{{ ucwords($parents->name) }}</button>
                                    </div>
                                    <div id="faq-accordion-collapse-{{ $count }}" class="accordion-collapse collapse"
                                                        ...
                                                        <tr class="intro-x">
                                                            ...
                                                            <td class="text-left">
                                                                <div
                                                                    ...
                                                                    <input id="show-example-1" name="chkCreate"
                                                                        class="show-code form-check-input mr-0 ml-3 chkCreate"
                                                            ...
                                                            <td class="text-left">
                                                                <div
                                                                    class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                                                                    <input id="show-example-1" name="chkUpdate"
                                                                        class="show-code form-check-input mr-0 ml-3 chkUpdate"
                                                                        value="1" type="checkbox">
                                                                </div>
                                                            </td>
                                                            <td class="text-left">
                                                                <div
                                                                    class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                                                                    <input id="show-example-1" name="chkDelete"
                                                                        class="show-code form-check-input mr-0 ml-3 chkDelete"
                                                                        value="1" type="checkbox">
                                                                </div>
                                                            </td>
                                                            <td class="text-left ">
                                                                <div
                                                                    class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                                                                    <input id="show-example-1" name="chkView"
                                                                        class="show-code form-check-input mr-0 ml-3 chkView"
                                                                        value="1" type="checkbox">
                                                                </div>
                                                        </tr>
                                                    @endforeach
