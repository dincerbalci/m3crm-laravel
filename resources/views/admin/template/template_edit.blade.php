                ...
                <div id="inline-form" class="p-5">
                    <div class="preview">
                        ...
                        <div class="form-check form-switch sm:mt-0" style="margin-top: 17px;margin-bottom: 10px;">
                            ...
                            <input id="show-example-3" data-target="#header" {{$template->is_active == '1' ? 'checked' : ''}} name="is_active" value='1' class="show-code form-check-input mr-0 ml-3" type="checkbox" >
                        </div>
