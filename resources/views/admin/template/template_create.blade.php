                ...
                <div id="inline-form" class="p-5">
                    <div class="preview">
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <input type="text" class="form-control col-span-4" name="template_name" placeholder="Tempate Name" aria-label="default input inline 2" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control col-span-4" name="template_subject" placeholder="Subject" aria-label="default input inline 2" required>
                        </div>
                        <div class="form-check form-switch sm:mt-0" style="margin-top: 17px;margin-bottom: 10px;">
                            ...
                            <input id="show-example-3" data-target="#header" name="is_active" checked value="1" class="show-code form-check-input mr-0 ml-3" type="checkbox" required>
                        </div>
                        
                        </div>
                        <textarea hidden name="template_detail" id="template_detail"></textarea>
                        <div class="grid grid-cols-12 gap-6 mt-5">
