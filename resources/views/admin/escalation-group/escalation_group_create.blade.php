                ...
                <div id="inline-form" class="p-5">
                    <div class="preview">
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <input type="text" name="group_name" class="form-control col-span-4" placeholder="Escalation Group Name" aria-label="default input inline 2" required>
                        ...
                        <div class="grid grid-cols-12 gap-2" id='clonediv'>
                            <div class="mt-3" >
                                ...
                                <input type="text" class="form-control col-span-4" name="full_name[]" placeholder="User Name" aria-label="default input inline 2">
                            </div>

                            <div class="mt-3" >
                                <label for="regular-form-1" class="form-label">User Email </label>
                                <input type="email" class="form-control col-span-4" name="email[]" placeholder="User Email" aria-label="default input inline 2">
                            </div>
