    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <form  method="POST" action="{{ route('complaint_product_create') }}" >
                    @csrf
                <div id="inline-form" class="p-5">
                    <div class="preview">
                        <div class="grid grid-cols-12 gap-2">
                            ...
                            <input type="text" class="form-control col-span-4" name="product_code" placeholder="Product Code" aria-label="default input inline 2" required>
                            </div>
                            <div>
                                ...
                                <select data-placeholder="Select your favorite actors" name='product_category_id' class="tom-select w-full tomselected" id="tomselect-1" tabindex="-1" hidden="hidden" required>
                                    ...
                                    <option value="{{$complainCategory[$i]->id}}" >{{ucwords($complainCategory[$i]->fullname)}}</option>
                                    @endfor
                                </select>
                            </div>
                            <div class="">
                                <label for="regular-form-1" class="form-label">Product Name<span style="color: red">*</span></label>
                                <input type="text" class="form-control col-span-4" name="product_name" placeholder="Product Name" aria-label="default input inline 2" required>
                                </div>
