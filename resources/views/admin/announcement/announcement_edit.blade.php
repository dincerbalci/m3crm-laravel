    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <form  method="POST" action="{{ route('announcement_update',$announcement->id) }}" >
                    @csrf
                <div id="inline-form" class="p-5">
                    <div class="preview">
                        ...
                        <div>
                            ...
                            <textarea id="validation-form-6" class="form-control" name="description" placeholder="Description" minlength="10" maxlength='255' required>{{$announcement->description}}</textarea>
                        </div>
