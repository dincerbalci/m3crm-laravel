    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box">
                ...
                <form id='complaint_form_search' method="GET" action="{{ route('report_sms_details') }}" >
                <div id="inline-form" class="p-5">
                    ...
                    <a href="{{route('report_sms_details')}}"  class="btn btn-inverse mt-5">Reset</a>
    ...
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
                ...
                <table class="table table-report sm:mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap" style="width: 8%;">Lodge By</th>
                            {{-- <th class="whitespace-nowrap" style="width: 20%">Description</th> --}}
            ...
            <div class="intro-y flex flex-wrap sm:flex-row sm:flex-nowrap items-center mt-3">
                {{ count($complaint) == 0 ? '' : $complaint->links('paginate.paginate_ui') }}
            </div>
        </div>
    </div>
    <!-- END: HTML Table Data -->
