...
<body class="login">
    <div class="container sm:px-10">
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <form class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0" action="{{ route('login') }}"
                method="post">
                @csrf
                <div
                    ...
                    @if ($message = Session::get('error'))
                        <div class="intro-y box mt-5">
                            <div class="alert alert-danger show flex items-center mb-2" role="alert"> <svg
                    ...
                    @if ($message = Session::get('success'))
                        <div class="intro-y box mt-5">
                            <div class="alert alert-success show flex items-center mb-2" role="alert"> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" icon-name="alert-octagon" data-lucide="alert-octagon"
                                    class="lucide lucide-alert-octagon w-6 h-6 mr-2">
