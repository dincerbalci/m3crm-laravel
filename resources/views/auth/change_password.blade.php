    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            <a href="" class="-intro-x flex items-center pt-5">
                ...
                <span class="text-white text-lg ml-3"> M3 CRM </span>
            </a>
            <div class="my-auto">
                <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16"
                     src="{{ asset('theme/dist/images/illustration.svg') }}">
        ...
        <form class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0" action="{{ route('change_password_update') }}"
              method="post">
            @csrf
            <div
                ...
                <div class="intro-x mt-8">
                    <div>
                        <input type="password" class="intro-x login__input form-control py-3 px-4 block"
                               name="old_password"
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    <button type="submit" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Update
                    </button>
