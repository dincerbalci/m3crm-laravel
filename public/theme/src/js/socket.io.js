    ...
    return (function(t) {
        ...
        function(t, e, n) {
            ...
            function o(t) {
                ...
                function o(t) {
                    function n() {
                        for (
                            var t = arguments.length, e = Array(t), i = 0; i < t; i++
                        )
                            e[i] = arguments[i];
                        if (n.enabled) {
                            var s = n,
            ...
            function o(t) {
                function n() {
                    if (n.enabled) {
                        ...
                        for (
                            var s = new Array(arguments.length), a = 0; a < s.length; a++
                        )
                            s[a] = arguments[a];
                        (s[0] = e.coerce(s[0])),
        ...
        function(t, e, n) {
            ...
            (e.deconstructPacket = function(t) {
                ...
                return (
                    (o.data = r(n, e)),
                    (o.attachments = e.length), { packet: o, buffers: e }
                );
            }),
            ...
            function r(t, e) {
                return this instanceof r ?
                    ((e = e || {}),
                        ...
                        (this.perMessageDeflate = !1 !== e.perMessageDeflate &&
                            (e.perMessageDeflate || {})), !0 === this.perMessageDeflate &&
        ...
        function(t, e, n) {
            ...
            function i(t, n, r) {
                ...
                return (
                    (o.onload = function() {
                        e.encodePacket({ type: t.type, data: o.result },
                            n, !0,
                            r
                        );
                    }),
            ...
            (e.decodePacket = function(t, n, r) {
                ...
                var i = new Uint8Array(t),
                    ...
                    s = f(t, 1);
                return (
                    w && "blob" === n && (s = new w([s])), { type: b[o], data: s }
                );
            }),
            (e.decodeBase64Packet = function(t, e) {
                ...
                return (
                    "blob" === e && w && (r = new w([r])), { type: n, data: r }
                );
            }),
                    ...
                    void c(t, r, function(t, e) {
                        ...
                        return (
                            e.forEach(function(t) {
                                ...
                                o[i++] = 255;
                                for (
                                    var r = new Uint8Array(n), s = 0; s < r.length; s++
                                )
                                    o[i++] = r[s];
                            }),
                            n(o.buffer)
                ...
                function r(t, n) {
                    e.encodePacket(t, !0, !0, function(t) {
                        ...
                        if (((e[0] = 1), "string" == typeof t)) {
                            for (
                                var r = new Uint8Array(t.length), o = 0; o < t.length; o++
                            )
                                r[o] = t.charCodeAt(o);
                            (t = r.buffer), (e[0] = 0);
                        }
        ...
        function(t, e) {
            ...
            (e.decode = function(t) {
                for (
                    var e = {}, n = t.split("&"), r = 0, o = n.length; r < o; r++
                ) {
                    var i = n[r].split("=");
        ...
        function(t, e, n) {
            ...
            i(r.prototype),
                ...
                (r.prototype.emitBuffered = function() {
                    ...
                    for (
                        this.receiveBuffer = [], t = 0; t < this.sendBuffer.length; t++
                    )
