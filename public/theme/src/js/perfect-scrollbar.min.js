...
!(function(t, e) {
    ...
    (l.prototype.unbind = function(e, i) {
        ...
        this.handlers[e] = this.handlers[e].filter(function(t) {
            return (!(!i || t === i) ||
                (l.element.removeEventListener(e, t, !1), !1)
            );
        });
    }),
    ...
    var W = {
            ...
            wheel: function(b) {
                ...
                function t(t) {
                    var e,
                        ...
                        o = r[1];
                    if (!(function(t, e, i) {
                            if (!w.isWebKit && g.querySelector("select:focus"))
                                return !0;
                        ...
                        b.settings.useBothWheelAxes ?
                            ...
                            (o ?
                                (g.scrollTop -=
                                    o * b.settings.wheelSpeed) :
                                (g.scrollTop +=
                                    n * b.settings.wheelSpeed),
                                (p = !0)) :
                            b.scrollbarXActive &&
                            !b.scrollbarYActive &&
                            (n ?
                            ...
                            (p =
                                ...
                                ((s = n),
                                    ...
                                    (d = 0 === g.scrollLeft),
                                    (f =
                                        g.scrollLeft + g.offsetWidth ===
                                        g.scrollWidth), !(Math.abs(a) > Math.abs(s) ?
                                        h || u :
                                        d || f) ||
        ...
        h = function(t, e) {
            ...
            if (
                (void 0 === e && (e = {}),
                    "string" == typeof t && (t = document.querySelector(t)), !t || !t.nodeName)
            )
                throw new Error(
            ...
            isNaN(this.scrollbarXBottom) ?
                ...
                (this.railBorderXWidth =
                    g(a.borderLeftWidth) + g(a.borderRightWidth)),
            ...
            isNaN(this.scrollbarYRight) ?
                ...
                (this.railBorderYWidth =
                    g(u.borderTopWidth) + g(u.borderBottomWidth)),
