...
(function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var h =
                        this.$.getBoundingClientRect(), n = d.$.documentElement, o = n.clientTop || g.$.clientTop || 0, m = n.clientLeft || g.$.clientLeft || 0, l = true;
                    if (CKEDITOR.env.ie) {
                ...
                k = a.getWindow();
                g = o(this, k);
                var j = o(a, k), q = this.$.offsetHeight;
                d = this.$.offsetWidth;
                var C = a.$.clientHeight, x = a.$.clientWidth;
    ...
    (function () {
        function b(a, b) {
            ...
            d = c.endContainer;
            var m = c.startOffset, l = c.endOffset, j, q = this.guard, f = this.type, e = a ? "getPreviousSourceNode" : "getNextSourceNode";
            ...
            if (a && !this._.guardRTL) {
                var A = o.type == CKEDITOR.NODE_ELEMENT ? o : o.getParent(), B = o.type == CKEDITOR.NODE_ELEMENT ? m ? o.getChild(m - 1) : null : o.getPrevious();
    ...
    (function () {
        ...
        var f = function (a) {
            ...
            var f = d.getParents(), i = g.getParents(), h, p, n;
            ...
            u: 1,
            "var": 1
        }, g = CKEDITOR.dom.walker.bogus(), k = new CKEDITOR.dom.walker.whitespaces, h = new CKEDITOR.dom.walker.bookmark, n = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var j = this.getCommonAncestor(), d = this.root, g, f, i, e, h, k = false, p, n;
                        p = this.startContainer;
                        n = this.startOffset;
                        if (p.type == CKEDITOR.NODE_TEXT) {
                            if (n) {
                                p = !CKEDITOR.tools.trim(p.substring(0, n)).length && p;
                                k = !!p
                            }
                            if (p && !(e = p.getPrevious()))i = p.getParent()
                        } else {
                            n &&
                            (e = p.getChild(n - 1) || p.getLast());
                            e || (i = p)
                        }
                        for (; i || e;) {
                            if (i && !e) {
                            ...
                            for (; e;) {
                                ...
                                if (e.type == CKEDITOR.NODE_COMMENT)e = e.getPrevious(); else {
                                    if (e.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        n =
                                            e.getText();
                                        if (/[^\s\ufeff]/.test(n))e = null; else for (var u = e.$.getElementsByTagName("*"), r = 0, D; D = u[r++];)if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) {
                                            e = null;
                                            break
                                        }
                                        e && (p = !!n.length)
                        ...
                        h = k = false;
                        if (p.type == CKEDITOR.NODE_TEXT) {
                            p = !CKEDITOR.tools.trim(p.substring(n)).length && p;
                            k = !(p && p.getLength());
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            i = this.clone();
                            i = new CKEDITOR.dom.walker(i);
                            var G = CKEDITOR.dom.walker.whitespaces(), z = CKEDITOR.dom.walker.bookmark();
                ...
                if (!this.collapsed) {
                    ...
                    var j = new CKEDITOR.dom.walker(j), n = CKEDITOR.dom.walker.bookmark();
            ...
            moveToPosition: function (a, b) {
                ...
                for (var l = 0; b;) {
                    if (b.type == CKEDITOR.NODE_TEXT) {
                        c && this.checkEndOfBlock() && n.test(b.getText()) ? this.moveToPosition(b, CKEDITOR.POSITION_BEFORE_START) : this.moveToPosition(b, c ? CKEDITOR.POSITION_AFTER_END :
        ...
        b.prototype = {
            getNextParagraph: function (b) {
                ...
                for (this._.nextNode = null; j;) {
                    var q = 0, C = j.hasAscendant("pre"), x = j.type != CKEDITOR.NODE_ELEMENT, i = 0;
                    if (x)j.type == CKEDITOR.NODE_TEXT && a.test(j.getText()) && (x = 0); else {
                        var s = j.getName();
                        if (j.isBlockBoundary(this.forceBrBreak && !C && {br: 1})) {
                            if (s == "br")x = 1; else if (!h && !j.getChildCount() && s != "hr") {
                                e = j;
                                n = j.equals(o);
                                break
                            }
                    ...
                    if (h && !q)for (; !j.getNext(d) && !n;) {
                        s = j.getParent();
                        if (s.isBlockBoundary(this.forceBrBreak && !C && {br: 1})) {
                            q = 1;
                            x = 0;
                            n || s.equals(o);
                ...
                if (!e) {
                    ...
                    } else if (!n)this._.nextNode = e.equals(o) ? null : c(h.getBoundaryNodes().endNode, 1, o)
                }
                if (m)(h = e.getPrevious()) && h.type == CKEDITOR.NODE_ELEMENT && (h.getName() == "br" ? h.remove() : h.getLast() && h.getLast().$.nodeName.toLowerCase() == "br" && h.getLast().remove());
                if (l)(h = e.getLast()) && h.type == CKEDITOR.NODE_ELEMENT && h.getName() == "br" && (CKEDITOR.env.ie || h.getPrevious(f) || h.getNext(f)) && h.remove();
                if (!this._.nextNode)this._.nextNode = n ||
                e.equals(o) || !o ? null : c(e, 1, o);
                return e
            }
        };
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (a, f, e, d) {
                ...
                g && (a = [a]);
                e || (e = CKEDITOR);
                var k = a.length, h = [], n = [], o = function (a) {
    ...
    (function () {
        function b(b, j, m) {
            ...
            if (j !== void 0) {
                ...
                if (m == CKEDITOR.ELEMENT_MODE_INLINE && !j.is(CKEDITOR.dtd.$editable) || m == CKEDITOR.ELEMENT_MODE_REPLACE &&
        ...
        function f(a) {
            var b = this.commands, c = a.editor, d = a.data.path, m;
            for (m in b) {
                a = b[m];
        ...
        function e(a) {
            ...
            if (!b)return false;
            var b = CKEDITOR.getUrl(b), c = m[b] || (m[b] = {});
            if (c.fn) {
        ...
        function h(a) {
            var b = a.config, c = b.plugins, d = b.extraPlugins, m = b.removePlugins;
            if (d)var e = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(e, ""), c = c + ("," + d);
            if (m)var g = RegExp("(?:^|,)(?:" + m.replace(/\s*,\s*/g, "|") + ")(?=,|$)",
                "g"), c = c.replace(g, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                CKEDITOR.scriptLoader.load(e, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++)for (var g = 0; g < d.length; g++) {
                        var f = d[g];
                        e === 0 && (m[g] && f.lang && f.langEntries) &&
                        (a.lang[f.name] = f.langEntries[m[g]]);
                        if (f[c[e]])f[c[e]](a)
                    }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            setData: function (a, b, c) {
                ...
                for (var a = this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, m = b.length; m--;) {
                    c = b[m];
                    d = 0;
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (e, d, g) {
            function k(a) {
                ...
                if (C.length > 0)for (var c = 0; c < C.length; c++) {
                    var d = C[c], l = d.name, j = CKEDITOR.dtd[l], m = i.name &&
                        CKEDITOR.dtd[i.name];
            ...
            var j = new CKEDITOR.htmlParser, q = d instanceof CKEDITOR.htmlParser.element ? d : typeof d == "string" ? new CKEDITOR.htmlParser.element(d) : new CKEDITOR.htmlParser.fragment, C = [], x = [], i = q, s = q.name == "textarea", A = q.name == "pre";
            j.onTagOpen = function (d, m, g, e) {
                m = new CKEDITOR.htmlParser.element(d, m);
                if (m.isUnknown && g)m.isEmpty = true;
                m.isOptionalClose = e;
                if (b(m))C.push(m); else {
                    ...
                    if (d == "br")x.push(m); else {
                        for (; ;) {
                            e = (g = i.name) ? CKEDITOR.dtd[g] || (i._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : f;
                            if (!m.isUnknown && !i.isUnknown && !e[d])if (i.isOptionalClose)j.onTagClose(g); else if (d in a && g in a) {
                                g = i.children;
                                ...
                                if (i.parent)o(i, i.parent, 1); else {
                                    m.isOrphan = 1;
                                    break
                                }
                            } else break
    ...
    (function () {
        function b(b, c) {
                ...
                return function (l) {
                    if (l.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (g)for (j(g, 1) && e.push(g); g;) {
                            if (d(g) && (i = f(g)) && j(i))if ((E = f(i)) && !d(E))e.push(i); else {
                                var q = i, n = m(t), k = q.parent.children, x = CKEDITOR.tools.indexOf(k, q);
                                k.splice(x + 1, 0, n);
                                k = q.next;
                                q.next = n;
                                n.previous = q;
            ...
            function j(a, b) {
                ...
                var c;
                if (a.type ==
                    CKEDITOR.NODE_TEXT && (c = a.value.match(A))) {
                    if (c.index) {
            ...
            var i = {elements: {}}, t = c == "html", q = CKEDITOR.tools.extend({}, u), n;
        ...
        function C(a) {
            return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g, function (a) {
                return "<\!--" + B + "{C}" + encodeURIComponent(a).replace(/--/g,
                        "%2D%2D") + "--\>"
            })
        }
        ...
        function s(a, b) {
            for (var c = [], d = b.config.protectedSource, m = b._.dataStore || (b._.dataStore = {id: 1}), l = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?<\/script>/gi,
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, d) {
                var a = s(a, this.editor), a = l(a), a = j(a), a = a.replace(z, "$1cke:$2"), a = a.replace(L,
                    "<cke:$1$2></cke:$1>"), a = CKEDITOR.env.opera ? a : a.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), m = this.editor.editable(), e;
        ...
        var A = /(?:&nbsp;|\xa0)$/, B = "{cke_protected}", p = CKEDITOR.dtd, F = ["caption", "colgroup", "col", "thead", "tfoot",
            "tbody"], u = CKEDITOR.tools.extend({}, p.$blockLimit, p.$block), r = {
            elements: {},
        ...
        var t = /<(a|area|img|input|source)\b([^>]*)>/gi, w = /\b(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, I = /(?:<style(?=[ >])[^>]*>[\s\S]*<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = {
            type: CKEDITOR.NODE_ELEMENT, add: CKEDITOR.htmlParser.fragment.prototype.add, clone: function () {
                ...
                var f = this.attributes, e = this, d = e.name, g, k, h, n;
    ...
    (function () {
        ...
        function a(a) {
            var b = a.name, c = a.element, f = a.elementMode, n = a.fire("uiSpace", {
                space: "top",
                html: ""
            }).html, o = a.fireOnce("uiSpace", {space: "bottom", html: ""}).html;
            ...
            a.container = b;
            n && a.ui.space("top").unselectable();
            o && a.ui.space("bottom").unselectable();
            c =
                a.config.width;
            f = a.config.height;
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            var f = this.container, o = this.ui.space("contents"), m = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, e = e ? f.getChild(1) : f;
            e.setSize("width", a, true);
            m && (m.style.width = "1%");
            o.setStyle("height", Math.max(b - (c ? 0 : (e.$.offsetHeight || 0) - (o.$.clientHeight || 0)), 0) +
                "px");
            m && (m.style.width = "100%");
            this.fire("resize")
        };
    ...
    (function () {
        function b(b) {
            ...
            if (CKEDITOR.env.gecko) {
                var h = e.block || e.blockLimit || e.root, n = h && h.getLast(a);
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            $: function (a, b) {
                ...
                focus: function () {
                    ...
                    d(this);
                    for (var c =
                        this.editor, e = c.config.enterMode, f = c.getSelection(), h = f.getRanges(), n = b.getName(), i = CKEDITOR.dtd.$block[n], o, k, B, p = h.length - 1; p >= 0; p--) {
                        o = h[p];
                        if (!o.checkReadOnly()) {
                            o.deleteContents(1);
                            k = !p && b || b.clone(1);
                            var F, u;
                            if (i)for (; (F = o.getCommonAncestor(0, 1)) && (u = CKEDITOR.dtd[F.getName()]) && (!u || !u[n]);)if (F.getName() in CKEDITOR.dtd.span)o.splitElement(F); else if (o.checkStartOfBlock() && o.checkEndOfBlock()) {
                                o.setStartBefore(F);
                                o.collapse(true);
                                F.remove()
                    ...
                    if (B) {
                        ...
                        if (i)if ((b = B.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))b.getDtd()["#"] ? o.moveToElementEditStart(b) : o.moveToElementEditEnd(B); else if (!b && e != CKEDITOR.ENTER_BR) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in {8: 1, 46: 1}) {
                                ...
                                if (l = e(l)) {
                                    ...
                                    (g = f.blockLimit.getAscendant("table")) && b.checkBoundaryOfElement(g, c ? CKEDITOR.START : CKEDITOR.END) && (n = g[c ? "getPrevious" : "getNext"](h))) {
                                    a.fire("saveSnapshot");
                                    b["moveToElementEdit" + (c ? "End" : "Start")](n);
                                    ...
                                    b[c ?
                                        "moveToElementEditEnd" : "moveToElementEditStart"](n);
                                    b.select();
                                    d = 1
                                }
                            }
        ...
        var k = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
            h = CKEDITOR.dom.walker.whitespaces(true), n = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var o = function () {
            ...
            function c(a, d) {
                var e, f, j, g, t = [], n = d.range.startContainer;
                e = d.range.startPath();
            ...
            function d(a, c) {
                var e = [], f = a.getChildren(), l = f.count(),
                    g, t = 0, h = i[c], n = !a.is(i.$inline) || a.is("br");
                for (n && e.push(" "); t < l; t++) {
                    g = f.getItem(t);
            ...
            function f(a, c, d, e) {
                ...
                if ((j = (new CKEDITOR.dom.walker(l)).next()) && b(j) && h[j.getName()] && (g = j.getPrevious()) && b(g) && !g.getParent().equals(a.startContainer) && d.contains(g) && e.contains(j) && j.isIdentical(g)) {
                    j.moveChildren(g);
                    j.remove();
                    f(a, c, d, e)
                }
            ...
            var i = CKEDITOR.dtd, h = {
                ...
                dl: 1,
                blockquote: 1
            }, o = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, k = CKEDITOR.tools.extend({}, i.$inline);
            delete k.br;
            return function (h, s, u) {
                ...
                if (!D.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(D.startContainer, D.root)).blockLimit || D.root, s = {
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, r = s.range, v = s.mergeCandidates, t, w, I, G, z;
                    ...
                    for (; (z = b(r.startContainer) && r.startContainer.getChild(r.startOffset - 1)) && b(z) && z.isBlockBoundary() && I.contains(z);)r.moveToPosition(z, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    if (u) {
                        ...
                        if (s.type == "text" && s.inlineStylesRoot) {
                            ...
                            z = r.getOuterHtml().replace("{cke-peak}",
                                w)
                        }
                        ...
                        s.dataWrapper = w;
                        E = s.range;
                        var L = E.document, y, u = s.blockLimit;
                        w = 0;
                        var J;
                        z = [];
                        var H, N, v = r = 0, K, O;
                        ...
                        for (n(I, E); w < I.length; w++) {
                            ...
                            if (y = G.isLineBreak) {
                                ...
                                if (G.hasBlockSibling)y = 1; else {
                                    ...
                                    if (!M || !M.is({div: 1, p: 1}))y =
                                        0; else {
                                        R = M.getPosition(K);
                                        if (R == CKEDITOR.POSITION_IDENTICAL || R == CKEDITOR.POSITION_CONTAINS)y = 0; else {
                                            K = y.splitElement(M);
    ...
    (function () {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            f.on("contentDom", function () {
                var a = f.document, e = CKEDITOR.document, l = f.editable(), g = a.getBody(), m = a.getDocumentElement(), h = l.isInline(), o;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                var a = n ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var f = d.children, g, j, m = b.duplicate(), h = 0, n = f.length - 1, o = -1, k, v; h <= n;) {
                            ...
                            if (k > 0)n = o - 1; else if (k < 0)h = o + 1; else {
                ...
                return function (b) {
                    ...
                    if (b)for (var d =
                        ...
                        if (!f.collapsed) {
                            ...
                            b = f.startContainer;
                            g = f.endContainer;
                            var h = f.startOffset, n = f.endOffset, o = f.clone();
                            b && b.type == CKEDITOR.NODE_TEXT && (h >= b.getLength() ? o.setStartAfter(b) : o.setStartBefore(b));
                            g &&
                            g.type == CKEDITOR.NODE_TEXT && (n ? o.setEndAfter(g) : o.setEndBefore(g));
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && o[c.getName()] &&
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    if (n) {
                        ...
                        if (p) {
                            ...
                            h = !(h && h.getText && h.getText().match(e)) && (i || !g.hasPrevious() || g.getPrevious().is && g.getPrevious().is("br"));
    ...
    (function () {
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                a.trim();
                var n = a.createBookmark(), i = n.startNode, o = n.endNode, m = i, k;
                if (!g) {
                    var q = a.getCommonAncestor(), g = b(i, q), q = b(o, q);
                ...
                for (m.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m;) {
                    ...
                    if (m.equals(o)) {
                        ...
                        var p = m.type, r = p == CKEDITOR.NODE_ELEMENT ? m.getName() : null, q = r && m.getAttribute("contentEditable") == "false", s = r && m.getAttribute("data-nostyle");
                        ...
                        if (!r || j[r] && !s && (!q || h) && (m.getPosition(o) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule || e.childRule(m))) {
                            ...
                            if (u && ((u.getDtd() || CKEDITOR.dtd.span)[d] || f) && (!e.parentRule || e.parentRule(u))) {
                                if (!k && (!r || !CKEDITOR.dtd.$removeEmpty[r] || (m.getPosition(o) | CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL |
                                ...
                                if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                    for (var p = m, v; (g = !p.getNext(D)) && (v = p.getParent(), j[v.getName()]) && (v.getPosition(i) | CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED) == CKEDITOR.POSITION_FOLLOWING + CKEDITOR.POSITION_IDENTICAL + CKEDITOR.POSITION_IS_CONTAINED && (!e.childRule ||
                                    e.childRule(v));)p = v;
                                    k.setEndAfter(p)
                                }
                            } else g = true
                    ...
                    getNextRange: function (g) {
                        ...
                        if (k && a.length > 1) {
                            ...
                            if (g)for (var n = 0; a[d + n + 1];) {
                                for (var o = k.document, g = 0, h = o.getById(c[n].endNode), o = o.getById(c[n +
                                1].startNode); ;) {
                                    h = h.getNextSourceNode(false);
                                    if (o.equals(h))g = 1; else if (b(h) || h.type == CKEDITOR.NODE_ELEMENT && h.isBlockBoundary())continue;
                                    break
                                }
                                if (!g)break;
                                n++
            ...
            CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                ...
                checkbox: function (b, a, d) {
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                            for (var f =
                                [], d = [], g = a.id ? a.id + "_radio" : CKEDITOR.tools.getNextId() + "_radio", k = 0; k < a.items.length; k++) {
                                var j = a.items[k], h = j[2] !== void 0 ? j[2] : j[0], l = j[1] !== void 0 ? j[1] : j[0], m = CKEDITOR.tools.getNextId() + "_radio_input", n = m + "_label", m = CKEDITOR.tools.extend({}, a, {
                                    id: m,
                                    title: null,
                                    type: null
    ...
    (function () {
        function v(b) {
            function a() {
                ...
                (CKEDITOR.env.ie ? e : b.document.getDocumentElement()).on("mouseup", function () {
                    setTimeout(function () {
                        s()
                    }, 0)
                });
            ...
            function c() {
                return {
                    canUndo: !1, async: !0, exec: function (b, a) {
                        ...
                        "string" == typeof a ? c({type: "auto", dataValue: a}, 1) :
            ...
            function j() {
                if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
                    ...
                    if (e.getType() ==
                        CKEDITOR.SELECTION_ELEMENT && (a = e.getSelectedElement()))c = e.getRanges()[0], d = b.document.createText(""), d.insertBefore(a), c.setStartBefore(d), c.setEndAfter(a), e.selectRanges([c]), setTimeout(function () {
            ...
            function u(a) {
                var c =
                {type: "auto"}, d = b.fire("beforePaste", c);
                k(a, function (b) {
                ...
                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    ...
                    var q = CKEDITOR.tools.addFunction(d), r = CKEDITOR.tools.addFunction(function (b, e) {
                        ...
                        switch (e.getKeystroke()) {
                            ...
                            case f ? 37 : 39:
                            case CKEDITOR.SHIFT + 9:
                                return (f = CKEDITOR.document.getById(c + (b - 1))) || (f = CKEDITOR.document.getById(c + (a._.elementsPath.list.length -
                                    1))), f.focus(), !1;
                            case 27:
                                return a.focus(), !1;
                            case 13:
    ...
    (function () {
        ...
        function p(a) {
            var e, f = a.config, p = f.floatSpaceDockedOffsetX || 0, o = f.floatSpaceDockedOffsetY || 0, u = f.floatSpacePinnedOffsetX || 0, q = f.floatSpacePinnedOffsetY || 0, i = function (c) {
                ...
                d.removeStyle("left");
                d.removeStyle("right");
                var n = a.editable(), k = d.getClientRect(), b = n.getClientRect(), l = k.height, s = t("left");
                if (e) {
    ...
    (function () {
        CKEDITOR.plugins.add("stylescombo", {
            requires: "richcombo", init: function (d) {
                ...
                var l = d.config, i = d.lang.stylescombo, h = {},
                    j = [], c;
                d.ui.addRichCombo("Styles", {
                    ...
                    onOpen: function () {
                        var a = d.getSelection().getSelectedElement(), a = d.elementPath(a), c = [0, 0, 0, 0];
                        this.showAll();
                        this.unmarkAll();
                        for (var b in h) {
                            var f = h[b], e = f.type;
